let ctgnum = 1; //category number selected by the user
let sentence = []; //entire final sentence will be saved here
let selectionOfCtg = [];
let component = [];
let lastCtg = [];
const mA = ["May Allah Taala", "May Allah the Almighty"];

//function to create smallest part of entire phrase
...
console.log(`main_function took ${t1 - t0} milliseconds.`);
